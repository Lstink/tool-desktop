...
func (xl XlMessage) GetBalanceForBusBack() (data Data) {
	...
	data.List = append(data.List, Item{Key: "0：30～1：00时段费率号", Value: getParseData(xl.Data[86:88], Bin)})
	data.List = append(data.List, Item{Key: "1：00～1：30时段费率号", Value: getParseData(xl.Data[88:90], Bin)})
	data.List = append(data.List, Item{Key: "1：30～2：00时段费率号", Value: getParseData(xl.Data[90:92], Bin)})
	data.List = append(data.List, Item{Key: "2：00～2：30时段费率号", Value: getParseData(xl.Data[92:94], Bin)})
	data.List = append(data.List, Item{Key: "2：30～3：00时段费率号", Value: getParseData(xl.Data[94:96], Bin)})
	data.List = append(data.List, Item{Key: "3：00～3：30时段费率号", Value: getParseData(xl.Data[96:98], Bin)})
	data.List = append(data.List, Item{Key: "3：30～4：00时段费率号", Value: getParseData(xl.Data[98:100], Bin)})
	data.List = append(data.List, Item{Key: "4：00～4：30时段费率号", Value: getParseData(xl.Data[100:102], Bin)})
	data.List = append(data.List, Item{Key: "4：30～5：00时段费率号", Value: getParseData(xl.Data[102:104], Bin)})
	data.List = append(data.List, Item{Key: "5：00～5：30时段费率号", Value: getParseData(xl.Data[104:106], Bin)})
	data.List = append(data.List, Item{Key: "5：30～6：00时段费率号", Value: getParseData(xl.Data[106:108], Bin)})
	data.List = append(data.List, Item{Key: "6：00～6：30时段费率号", Value: getParseData(xl.Data[108:110], Bin)})
	data.List = append(data.List, Item{Key: "6：30～7：00时段费率号", Value: getParseData(xl.Data[110:112], Bin)})
	data.List = append(data.List, Item{Key: "7：00～7：30时段费率号", Value: getParseData(xl.Data[112:114], Bin)})
	data.List = append(data.List, Item{Key: "7：30～8：00时段费率号", Value: getParseData(xl.Data[114:116], Bin)})
	data.List = append(data.List, Item{Key: "8：00～8：30时段费率号", Value: getParseData(xl.Data[116:118], Bin)})
	data.List = append(data.List, Item{Key: "8：30～9：00时段费率号", Value: getParseData(xl.Data[118:120], Bin)})
	data.List = append(data.List, Item{Key: "9：00～9：30时段费率号", Value: getParseData(xl.Data[120:122], Bin)})
	data.List = append(data.List, Item{Key: "9：30～10：00时段费率号", Value: getParseData(xl.Data[122:124], Bin)})
	data.List = append(data.List, Item{Key: "10：00～10：30时段费率号", Value: getParseData(xl.Data[124:126], Bin)})
	data.List = append(data.List, Item{Key: "10：30～11：00时段费率号", Value: getParseData(xl.Data[126:128], Bin)})
	data.List = append(data.List, Item{Key: "11：00～11：30时段费率号", Value: getParseData(xl.Data[128:130], Bin)})
	data.List = append(data.List, Item{Key: "11：30～12：00时段费率号", Value: getParseData(xl.Data[130:132], Bin)})
	data.List = append(data.List, Item{Key: "12：00～12：30时段费率号", Value: getParseData(xl.Data[132:134], Bin)})
	data.List = append(data.List, Item{Key: "12：30～13：00时段费率号", Value: getParseData(xl.Data[134:136], Bin)})
	data.List = append(data.List, Item{Key: "13：00～13：30时段费率号", Value: getParseData(xl.Data[136:138], Bin)})
	data.List = append(data.List, Item{Key: "13：30～14：00时段费率号", Value: getParseData(xl.Data[138:140], Bin)})
	data.List = append(data.List, Item{Key: "14：00～14：30时段费率号", Value: getParseData(xl.Data[140:142], Bin)})
	data.List = append(data.List, Item{Key: "14：30～15：00时段费率号", Value: getParseData(xl.Data[142:144], Bin)})
	data.List = append(data.List, Item{Key: "15：00～15：30时段费率号", Value: getParseData(xl.Data[144:146], Bin)})
	data.List = append(data.List, Item{Key: "15：30～16：00时段费率号", Value: getParseData(xl.Data[146:148], Bin)})
	data.List = append(data.List, Item{Key: "16：00～16：30时段费率号", Value: getParseData(xl.Data[148:150], Bin)})
	data.List = append(data.List, Item{Key: "16：30～17：00时段费率号", Value: getParseData(xl.Data[150:152], Bin)})
	data.List = append(data.List, Item{Key: "17：00～17：30时段费率号", Value: getParseData(xl.Data[152:154], Bin)})
	data.List = append(data.List, Item{Key: "17：30～18：00时段费率号", Value: getParseData(xl.Data[154:156], Bin)})
	data.List = append(data.List, Item{Key: "18：00～18：30时段费率号", Value: getParseData(xl.Data[156:158], Bin)})
	data.List = append(data.List, Item{Key: "18：30～19：00时段费率号", Value: getParseData(xl.Data[158:160], Bin)})
	data.List = append(data.List, Item{Key: "19：00～19：30时段费率号", Value: getParseData(xl.Data[160:162], Bin)})
	data.List = append(data.List, Item{Key: "19：30～20：00时段费率号", Value: getParseData(xl.Data[162:164], Bin)})
	data.List = append(data.List, Item{Key: "20：00～20：30时段费率号", Value: getParseData(xl.Data[164:166], Bin)})
	data.List = append(data.List, Item{Key: "20：30～21：00时段费率号", Value: getParseData(xl.Data[166:168], Bin)})
	data.List = append(data.List, Item{Key: "21：00～21：30时段费率号", Value: getParseData(xl.Data[168:170], Bin)})
	data.List = append(data.List, Item{Key: "21：30～22：00时段费率号", Value: getParseData(xl.Data[170:172], Bin)})
	data.List = append(data.List, Item{Key: "22：00～22：30时段费率号", Value: getParseData(xl.Data[172:174], Bin)})
	data.List = append(data.List, Item{Key: "22：30～23：00时段费率号", Value: getParseData(xl.Data[174:176], Bin)})
	data.List = append(data.List, Item{Key: "23：00～23：30时段费率号", Value: getParseData(xl.Data[176:178], Bin)})
	data.List = append(data.List, Item{Key: "23：30～24：00时段费率号", Value: getParseData(xl.Data[178:180], Bin)})
